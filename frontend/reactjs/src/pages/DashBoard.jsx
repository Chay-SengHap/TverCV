  ...
  return (
    <div>
      <div className=' max-w-7xl mx-auto px-4 py-8'>
        ...
        <p className=' text-2xl font-medium mb-6 bg-gradient-to-r from-slate-600 to-slate-700 bg-clip-text text-transparent sm:hidden'>Welcome, Jonh Doe</p>
        ...
        <div className='flex gap-4'>
          ...
          <button
            ...
            <PlusIcon className=' size-11 transition-all duration-300 p-2.5 bg-gradient-to-br from-red-300 to-red-500 text-white rounded-full' />
          ...
          {/* Upload Existing */}
          <button onClick={() => setShowUploadResume(true)} className=' w-full bg-white sm:max-w-36 h-48 flex flex-col items-center justify-center rounded-lg gap-2 text-slate-600 border border-dashed border-slate-300 group hover:border-orange-500 hover:shadow-lg transition-all duration-300 cursor-pointer'>
