...
//  Controller for enchancing a resume's profesinal summary

import { Resume, PersonalInfo, Experience, Education, Project, Skill } from "../models/index.js";
import ai from "../config/ai.js";
import 'dotenv/config';


// Post /api/enhance-pro-sum
export const enhanceProfessionalSumary = async ()=>{
try {
    const {userContent} = req.body

    if(!userContent){
        return resizeBy.status(400).json({message : "Missing Required Fields"})
    }
